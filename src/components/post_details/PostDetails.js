        ...
        <div className='post'>
                <div className='post_details'>
                    ...
                    <div className='post_description'>
                        <p>
                        Great for entertaining: spacious, updated 2 bedroom, 1 bathroom apartment in Lakeview, available May 1st. Close to nightlife with private backyard. 
                    <br/> <br/> wifi , 2 bedrooms , available May 1st. Close to nightlife with private backyard. available May 1st. Close to nightlife with private acces
                        </p>
                    </div>
                    ...
                    <Button className='post_visit-button'>
                    Validate
                    </Button>
